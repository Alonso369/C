...
//Exemplo de uso da função calloc para alocação dinâmica de memória
...
int main()
{
    ...
    p = (int *) calloc(num, sizeof(int)); // p é um vetor de tamanho num
    if(p == NULL){
    ...
    free(p);//libera da memória o vetor com as posições alocadas
    printf("\n");
